...
fs = list(feature_score_717.feature[:500])
...
newdata[newdata<0] = -1
from sklearn.cross_validation import train_test_split
feature_selected = list(feature_score_717.feature[:500])
rank_feature_selected = list(rank_feature_score.feature[:500])
discret_feature_selected = list(discret_feature_score.feature[:100])
